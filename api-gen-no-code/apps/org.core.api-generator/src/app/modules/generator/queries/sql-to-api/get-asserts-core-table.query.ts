...
export class GetInitCoreTableScriptQuery { }

@QueryHandler(GetInitCoreTableScriptQuery)
export class GetInitCoreTableScriptQueryHandler
  implements IQueryHandler<GetInitCoreTableScriptQuery>
{
  constructor(
  ...
  execute(): Promise<string> {
    const fileName = `private/scripts/pg/init-core-table.sql`;
